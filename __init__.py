...
def _register_highway_envs():
    ...
    register(
        id="intersection-traffic-light-v0",
        entry_point="highway_env.envs.intersection_traffic_light_env:IntersectionTrafficLightEnv",
    )
    ...
    register(
        id="test-v0",
        entry_point="highway_env.envs.test_env:TestEnv",
    )
