...
# from highway_env.envs.intersection_traffic_light_env import IntersectionTrafficLightEnv
from highway_env.traffic_light.graphics import TrafficLightGraphics
    ...
    def display(cls, obs, sim_surface):
        ...
        for observation in observations:
            ...
            if isinstance(observation, LidarObservation):
                cls.display_grid(observation, sim_surface)
