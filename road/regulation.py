...
from highway_env.traffic_light.traffic_light import TrafficLightNetwork
...
class RegulatedRoad(Road):
    ...
    def __init__(
        ...
        traffic_light_network: TrafficLightNetwork = None,
    ) -> None:
        super().__init__(network, vehicles, obstacles, np_random, record_history, traffic_light_network)
        self.steps = 0
